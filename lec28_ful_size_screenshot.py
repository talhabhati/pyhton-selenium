...
#yeh css ka code ha
tot_width=driver.execute_script("return document.body.offsetWidth")
tot_lenght=driver.execute_script("return document.body.offsetHeigth")
print(tot_width)
print(tot_lenght)
driver.set_window_size(tot_width,tot_lenght)
